...
namespace FMAplication.Migrations
{
    ...
    [Migration("20210406060113_Remote_WDistributionTransaction_SalespointId_field")]
    partial class Remote_WDistributionTransaction_SalespointId_field
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FMAplication.Domain.Transaction.WDistributionRecieveTransaction", b =>
                {
                    ...
                    b.Property<int>("WDistributionTransactionId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("WDistributionTransactionId");
            ...
            modelBuilder.Entity("FMAplication.Domain.Reports.SurveyReport", b =>
                {
                    ...
                    b.HasOne("FMAplication.Domain.Examples.Survey", "Survey")
                        .WithMany()
            ...
            modelBuilder.Entity("FMAplication.Domain.Transaction.WDistributionRecieveTransaction", b =>
                {
                    b.HasOne("FMAplication.Domain.Transaction.WDistributionTransaction", "WDistributionTransaction")
                        .WithMany()
                        .HasForeignKey("WDistributionTransactionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("FMAplication.Domain.Users.CMUser", b =>
                {
                    b.HasOne("FMAplication.Domain.Users.UserInfo", null)
                        .WithMany("CMUsers")
