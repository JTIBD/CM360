...
{
    public partial class GuidelineSetupModelCreated : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "GuidelineSetups",
                columns: table => new
                {
                    ...
                    GuidelineText = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GuidelineSetups", x => x.Id);
                    table.ForeignKey(
