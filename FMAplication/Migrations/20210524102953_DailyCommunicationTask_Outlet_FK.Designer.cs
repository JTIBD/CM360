...
namespace FMAplication.Migrations
{
    ...
    [Migration("20210524102953_DailyCommunicationTask_Outlet_FK")]
    partial class DailyCommunicationTask_Outlet_FK
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FMAplication.Domain.TransactionWorkFlows.TransactionWorkflow", b =>
                {
                    ...
                    b.ToTable("TransactionWorkflow");
                });

            modelBuilder.Entity("FMAplication.Domain.TransactionWorkFlows.TransactionWorkflowLogs", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("TransactionWorkflowId");

                    b.HasIndex("WorkFlowConfigurationId");

                    b.ToTable("TransactionWorkflowLogs");
                });
            ...
            modelBuilder.Entity("FMAplication.Domain.DailyTasks.DailyAVTask", b =>
                {
                    ...
                    b.HasOne("FMAplication.Domain.Sales.Outlet", "Outlet")
                        .WithMany()
            ...
            modelBuilder.Entity("FMAplication.Domain.Sales.SalesPointReceivedTransfer", b =>
                {
                    b.HasOne("FMAplication.Domain.Sales.SalesPoint", "ToSalesPoint")
                        .WithMany()
                        .HasForeignKey("ToSalesPointId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("FMAplication.Domain.Sales.SalesPointTransfer", b =>
                {
                    b.HasOne("FMAplication.Domain.Sales.SalesPoint", "FromSalesPoint")
                        .WithMany()
                        .HasForeignKey("FromSalesPointId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("FMAplication.Domain.TransactionWorkFlows.TransactionWorkflowLogs", b =>
                {
                    b.HasOne("FMAplication.Domain.TransactionWorkFlows.TransactionWorkflow", "TransactionWorkflow")
                        .WithMany()
                        .HasForeignKey("TransactionWorkflowId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FMAplication.Domain.WorkFlows.WorkFlowConfiguration", "WorkFlowConfiguration")
                        .WithMany()
