...
namespace FMAplication.Migrations
{
    ...
    [Migration("20210420072214_Table_AvSetup")]
    partial class Table_AvSetup
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FMAplication.Domain.AVCommunication.AvCommunication", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FMAplication.Domain.AVCommunication.AvSetup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FMAplication.Domain.AVCommunication.AvSetup", b =>
                {
                    b.HasOne("FMAplication.Domain.AVCommunication.AvCommunication", "Av")
                        .WithMany()
                        .HasForeignKey("AvId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
