...
namespace FMAplication.Migrations
{
    ...
    [Migration("20210628131312_Reason_Type_Mapping_Column")]
    partial class Reason_Type_Mapping_Column
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FMAplication.Domain.ReasonReasonTypeMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ReasonReasonTypeMappings");
                });

            modelBuilder.Entity("FMAplication.Domain.ReasonType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FMAplication.Domain.SPWisePOSMLedgers.SPWisePOSMLedger", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FMAplication.Domain.ReasonReasonTypeMapping", b =>
                {
                    ...
                    b.HasOne("FMAplication.Domain.ReasonType", "ReasonType")
                        .WithMany()
            ...
            modelBuilder.Entity("FMAplication.Domain.Sales.SalesPointTransferItem", b =>
                {
                    ...
                    b.HasOne("FMAplication.Domain.Sales.SalesPointTransfer", "Transfer")
                        .WithMany("SalesPointTransferItems")
                        .HasForeignKey("TransferId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("FMAplication.Domain.Transaction.SalesPointAdjustmentItem", b =>
                {
                    ...
                    b.HasOne("FMAplication.Domain.Transaction.Transaction", "Transaction")
                        .WithMany("SalesPointAdjustmentItems")
            ...
            modelBuilder.Entity("FMAplication.Domain.Transaction.WDistributionTransaction", b =>
                {
                    ...
                    b.HasOne("FMAplication.Domain.Transaction.Transaction", "Transaction")
                        .WithMany("WDistributionTransactions")
                        .HasForeignKey("TransactionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
