...
namespace FMAplication.Migrations
{
    ...
    [Migration("20200428071540_DelegationTableAdd")]
    partial class DelegationTableAdd
    {
            ...
            modelBuilder.Entity("FMAplication.Domain.Users.Delegation", b =>
                {
                    ...
                    b.Property<int>("DeligatedFromUserInfoId")
                        .HasColumnType("int");

                    b.Property<int>("DeligatedToUserId")
                        .HasColumnType("int");

                    b.Property<int>("DeligatedToUserInfoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DeligatedFromUserInfoId");

                    b.HasIndex("DeligatedToUserInfoId");
            ...
            modelBuilder.Entity("FMAplication.Domain.Users.Delegation", b =>
                {
                    b.HasOne("FMAplication.Domain.Users.UserInfo", "DeligatedFromUserInfo")
                        .WithMany()
                        .HasForeignKey("DeligatedFromUserInfoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FMAplication.Domain.Users.UserInfo", "DeligatedToUserInfo")
                        .WithMany()
                        .HasForeignKey("DeligatedToUserInfoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
