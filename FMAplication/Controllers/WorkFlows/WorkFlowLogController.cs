...
namespace FMAplication.Controllers.WorkFlowLogs
{
    [ApiController]
    [JwtAuthorize]
    [ApiVersion("1")]
    ...
    {
        private readonly ILogger<Controllers.WorkFlowLogs.WorkFlowLogController> _logger;
        private readonly IWorkFlowLogService _workFlowLog;

        public WorkFlowLogController(ILogger<Controllers.WorkFlowLogs.WorkFlowLogController> logger,
