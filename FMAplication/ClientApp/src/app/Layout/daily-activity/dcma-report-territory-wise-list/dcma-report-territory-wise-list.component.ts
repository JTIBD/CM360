...
@Component({
    selector: 'app-dcma-report-territory-wise-list',
    templateUrl: './dcma-report-territory-wise-list.component.html',
    styleUrls: ['./dcma-report-territory-wise-list.component.css']
})
export class DCMAReportTerritoryWiseListComponent implements OnInit {
    ...
    public fnExeclDownload() {
        ...
        this.cmTaskGenerationService.getDCMAReportsTerritoryWise(1, Utility.MaximumWorkableInteger, "").subscribe(res=>{
    ...
    getAllReportData(pageIndex, pageSize, search, isAll = false) {
        ...
        this.cmTaskGenerationService.getDCMAReportsTerritoryWise(pageIndex, pageSize, search).subscribe(
            (res) => {
    ...
    public ptableSettings: IPTableSetting = {
        ...
        tableName: 'DCMA Territory Reports',
