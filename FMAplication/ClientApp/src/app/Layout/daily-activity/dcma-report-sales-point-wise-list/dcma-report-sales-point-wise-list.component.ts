...
@Component({
    selector: 'app-dcma-report-sales-point-wise-list',
    templateUrl: './dcma-report-sales-point-wise-list.component.html',
    styleUrls: ['./dcma-report-sales-point-wise-list.component.css']
})
export class DCMAReportSalesPointWiseListComponent implements OnInit {
    ...
    public fnExeclDownload() {
        // this.getAllReportData(this.pageIndex, this.pageSize, this.search);
        this.cmTaskGenerationService.getDCMAReportsSalesPointWise(1, Utility.MaximumWorkableInteger, "").subscribe(res=>{            
    ...
    getAllReportData(pageIndex, pageSize, search) {
        ...
        this.cmTaskGenerationService.getDCMAReportsSalesPointWise(pageIndex, pageSize, search).subscribe(
            (res) => {
                //this.DCMAReportInDetailsList = res.data;
    ...
    public ptableSettings: IPTableSetting = {
        ...
        tableName: 'DCMA Sales Point Reports',
