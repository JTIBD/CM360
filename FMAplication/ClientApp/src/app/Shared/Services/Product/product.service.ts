...
export class ProductService {
    ...
    public postProduct(model) {
        ...
        return this.http.post<APIResponse>(this.baseUrl + 'v1/product/save', this.commonService.toFormData(model));
    }

    public putProduct(model) {
        return this.http.put<APIResponse>(this.baseUrl + 'v1/product/update', this.commonService.toFormData(model));
    }
